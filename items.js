const ALL_ITEMS = [
  ...
  { id: 'doubloon', name: 'Дублон', desc: 'Каждый прокрут с шансом 10% даёт +1 дополнительный прокрут.', cost: 2, rarity: 'rare', thumbnail: '🏴',
  ...
  { id: 'golden_lemon_polish', name: 'Позолота лимона', desc: 'С шансом 20% превращает символ 🍋 в золотой. Его номинал умножается на 3.', cost: 6, rarity: 'rare', thumbnail: '🍋✨', effect: { golden_symbol_chance: { symbol: 'lemon', chance: 0.20, multiplier: 3 } } },
  { id: 'golden_cherry_polish', name: 'Позолота вишни', desc: 'С шансом 20% превращает символ 🍒 в золотой. Его номинал умножается на 3.', cost: 6, rarity: 'rare', thumbnail: '🍒✨', effect: { golden_symbol_chance: { symbol: 'cherry', chance: 0.20, multiplier: 3 } } },
  { id: 'golden_clover_polish', name: 'Позолота клевера', desc: 'С шансом 20% превращает символ 🍀 в золотой. Его номинал умножается на 3.', cost: 6, rarity: 'rare', thumbnail: '🍀✨', effect: { golden_symbol_chance: { symbol: 'clover', chance: 0.20, multiplier: 3 } } },
  { id: 'golden_bell_polish', name: 'Позолота колокольчика', desc: 'С шансом 20% превращает символ 🔔 в золотой. Его номинал умножается на 3.', cost: 6, rarity: 'rare', thumbnail: '🔔✨', effect: { golden_symbol_chance: { symbol: 'bell', chance: 0.20, multiplier: 3 } } },
  { id: 'golden_diamond_polish', name: 'Позолота алмаза', desc: 'С шансом 20% превращает символ 💎 в золотой. Его номинал умножается на 3.', cost: 6, rarity: 'rare', thumbnail: '💎✨', effect: { golden_symbol_chance: { symbol: 'diamond', chance: 0.20, multiplier: 3 } } },
  { id: 'golden_coins_polish', name: 'Позолота монет', desc: 'С шансом 20% превращает символ 💰 в золотой. Его номинал умножается на 3.', cost: 6, rarity: 'rare', thumbnail: '💰✨', effect: { golden_symbol_chance: { symbol: 'coins', chance: 0.20, multiplier: 3 } } },
  { id: 'golden_seven_polish', name: 'Позолота семёрки', desc: 'С шансом 20% превращает символ 7️⃣ в золотой. Его номинал умножается на 3.', cost: 6, rarity: 'rare', thumbnail: '7️⃣✨', effect: { golden_symbol_chance: { symbol: 'seven', chance: 0.20, multiplier: 3 } } },
