const ALL_ITEMS = [
  ...
  { id: 'lucky_five', name: 'Пятёрка удачи', desc: 'Линии из 5-ти символов приносят дополнительно +2💰.', cost: 3, rarity: 'common', thumbnail: '🖐️', effect: { on_line_win_bonus: { length: 5, coins: 2 } } },

  // --- НОВЫЕ ОБЫЧНЫЕ ПРЕДМЕТЫ (20 штук) ---
  ...
  { id: 'frugal_mindset', name: 'Экономное мышление', desc: 'В конце раунда получите +1💰 за каждый оставшийся прокрут.', cost: 3, rarity: 'common', thumbnail: '🧠', effect: { on_round_end_bonus: { per_spin_left: 1 } } }, // Логика в confirmEndTurn
  ...
  { id: 'almost_perfect', name: 'Почти идеально', desc: 'Линии из 4 символов дополнительно дают +2💰.', cost: 3, rarity: 'common', thumbnail: '👍', effect: { on_line_win_bonus: { length: 4, coins: 2 } } },
