const ALL_PASSIVES = [
...

    {
        ...
        desc: 'Если прокрут выигрышный, каждый Клевер 🍀 на поле приносит +1💲.',
        emoji: '☘️',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        id: 'wilder_clover',
        name: 'Дичайший клевер',
        desc: 'Если у вас есть "Дикий Клевер", каждый Клевер 🍀 на поле дополнительно приносит +1💲 при любом выигрыше.',
        emoji: '🃏',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        id: 'cherry_luck',
        name: 'Вишнёвая удача',
        desc: 'Каждая Вишня 🍒 на поле накапливает +1 к удаче для следующего прокрута.',
        emoji: '🍒',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        ...
        desc: 'Если у вас есть "Вишневая бомба", линии из вишен дают +1🎟️.',
        emoji: '💣',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        ...
        name: 'Ловкие пальцы',
        desc: 'Усиливает "Липкие пальцы": бонус за линию из 3-х символов увеличивается на +1💲.',
        emoji: '🖖',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        ...
        desc: 'Если у вас есть "Золотой Лимон", множитель Лимонов 🍋 увеличивается еще на +1.',
        emoji: '👆',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        ...
        desc: 'Улучшает "Кровавый Ритуал": стоимость снижается на 1💲, а бонус к удаче увеличивается на +2.',
        emoji: '🩸',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        ...
        desc: 'Удваивает шанс срабатывания предмета "Дублон".',
        emoji: '🏴‍☠️',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        ...
        desc: 'Предмет "Карманные часы" с шансом 50% дает +2 прокрута вместо +1.',
        emoji: '🕰️',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
    {
        ...
        desc: 'В начале раунда предлагает обменять до 5 талонов на монеты (курс 1 к 1).',
        emoji: '♻️',
        type: 'item_mod',
        effect: (state) => {} // Логика реализована в skript.js
    },
