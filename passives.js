const ALL_PASSIVES = [
    ...
    },
    {
        ...
        desc: 'Немедленно получите +33💰 и +3🎟️. Ваша базовая процентная ставка в банке перманентно снижается на 3%.',
        emoji: '😈',
        type: 'one_time',
        effect: (state) => { 
            state.coins += 33; 
    ...
    },
    {
        ...
        desc: 'Если вы заканчиваете раунд с 0 оставшихся прокрутов, вы получаете +5💰.',
        emoji: '🎲',
        type: 'slot_modifier',
    ...
    },
    {
        id: 'anticipation',
        name: 'Предвкушение',
        desc: 'Каждый раз, когда предмет с "шансом удачи" НЕ срабатывает, вы получаете +1💰.',
        emoji: '⏳',
        type: 'item_mod',
    ...
    },
    {
        ...
        desc: 'В начале каждого раунда вы можете обменять до 5🎟️ на 💰 по курсу 1 к 1.',
        emoji: '⚗️',
        type: 'slot_modifier',
